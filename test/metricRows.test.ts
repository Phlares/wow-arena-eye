...
function mkUnit(over: Partial<UnitMetrics>): UnitMetrics {
  return {
    ...
    interruptsSuffered: 0, interruptsSufferedBySpell: [], precognitionUptimeSec: 0, enemyPrecognitionUptimeSec: 0, avgHealerDistanceYd: null,
...
function mkMetrics(): MatchMetrics {
  ...
  return {
    ...
    offensiveWindows: [], attackerGoTracks: [], deathBlows: [], anchors: [], positionTracks: [], distanceBands: [],
