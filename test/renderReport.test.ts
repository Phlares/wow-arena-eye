...
describe('renderReport metrics block (per-player)', () => {
  const metrics: MatchMetrics = {
      ...
      }], attackerGoTracks: [], positionTracks: [], distanceBands: [], lineOfSight: { zoneId: '', resolved: false, approximate: false }, losDisruptors: [],
      teams: [
        {
          team: 'friendly',
          unownedPets: [],
          players: [
            {
              player: {
                ...
                precognitionUptimeSec: 0, enemyPrecognitionUptimeSec: 0, avgHealerDistanceYd: null,
